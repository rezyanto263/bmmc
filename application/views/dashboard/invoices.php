    ...
    <div class="modal-dialog modal-dialog-centered modal-fullscreen">
        <div class="modal-content">
            ...
            <div class="modal-footer border-0 justify-content-between" style="box-shadow: 0 -1rem 3rem rgba(0, 0, 0, 0.175)">
                ...
                <div>
                    <button class="btn-danger me-1" type="button" id="btnMarkInvoiceAsUnpaid" style="display: none;">MARK INVOICE AS UNPAID</button>
                    <button class="btn-primary" type="button" id="btnCreateInvoice">
                        <i class="las la-file-invoice-dollar fs-5 me-1 align-middle"></i>
...
<div class="modal fade" id="createInvoiceModal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="invoiceDiscount">
                <p>
                    <span class="text-danger">WARNING:</span> 
                    This action will create an invoice for the selected billing. Please make sure the data is correct before proceeding.
                </p>
                <input type="text" class="form-control" name="createInvoiceConfirmation" placeholder="Type 'CREATE' without quotes to confirm" oninput="this.value = this.value.toUpperCase()" autocomplete="off">
                <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>">
            </div>
            <div class="modal-footer border-0">
                ...
                <button type="submit" class="btn-primary" disabled>
                    <i class="las la-file-invoice-dollar fs-5 me-1 align-middle"></i>
                    <span class="align-middle">CREATE NOW</span>
                </button>
            </div>
            </form>
        </div>
