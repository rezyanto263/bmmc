<main>
    <div class="container d-flex justify-content-center align-items-center">
        <div class="card d-flex justify-content-center rounded-2 p-md-5 p-4">
            ...
            <form class="mb-5" action="<?= base_url('AuthUser/forgotPassword') ?>" method="POST">
                <div class="mb-4 p-0">
                    <div class="input-group p-0">
                        <span class="input-group-text bg-transparent">
                            <i class="las la-envelope fs-4"></i>
                        </span>
                        <input class="form-control" type="text" placeholder="Account Email" name="userEmail">
                    </div>
                    <?= form_error('userEmail', '<small class="text-danger px-0 lh-1">', '</small>'); ?>
                </div>
            ...
            <a class="text-center text-secondary mb-5 mx-auto" href="<?= base_url('login') ?>">Back to Login Page</a>
