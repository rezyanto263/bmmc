...
<body>
    <div class="container py-3">
        ...
        <!-- QR Code dan Profil User -->
        <div class="card text-center p-4">
            <div class="profile-header p-3">
                <img src="" class="rounded mx-auto d-block mb-3" alt="QR Code" style="width: 100px;">
            </div>
            
            <!-- Profil User -->
            <div class="d-flex align-items-center justify-content-center mb-2">
                <img src="user_image_url.jpg" class="rounded-circle mr-2" alt="User Image" style="width: 50px; height: 50px;">
                <div>
                    <h5 class="mb-0">Cicak Muslimah</h5>
                    <small class="text-muted">realnamurag@gmail.com</small>
                </div>
               <!-- Edit Icon Triggering Modal -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="accordion mb-3" id="familyAccordion">
                <!-- Member 1 -->
                <div class="card">
                    <div class="card-header p-2 d-flex align-items-center justify-content-between" id="headingOne">
                        <h2 class="mb-0">
                            <button class="btn btn-link text-dark" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true">
                                Jawir Pedia
                            </button>
                        </h2>
                ...
                <!-- Member 2 -->
                <div class="card">
                    <div class="card-header p-2 d-flex align-items-center justify-content-between" id="headingTwo">
                        <h2 class="mb-0">
                ...
                <!-- Member 3 -->
                <div class="card">
                    <div class="card-header p-2 d-flex align-items-center justify-content-between" id="headingThree">
                        <h2 class="mb-0">
                ...
                <!-- Member 4 -->
                <div class="card">
                    <div class="card-header p-2 d-flex align-items-center justify-content-between" id="headingFour">
                        <h2 class="mb-0">
                    ...
                    <div id="collapseFour" class="collapse" data-parent="#familyAccordion">
                        <div class="card-body">
                            Detail anggota keluarga.
                        </div>
                    </div>
            ...
            <!-- Tabel Jumlah Tanggungan yang sudah dicairkan -->
