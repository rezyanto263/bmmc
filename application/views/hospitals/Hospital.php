...
<div class="content-body py-3">
  <img src="https://th.bing.com/th/id/OIP.4Z-WeCh-EKNnE9eK8Q8j7wHaHd?rs=1&pid=ImgDetMain" class="img-thumbnail"
...
<div class="mb-3">
  ...
  <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder"
    value="RSUD Kota Medan" readonly>
</div>
<div class="mb-3">
  <label for="formGroupExampleInput2" class="form-label">Alamat</label>
  <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="Another input placeholder"
    value="Jl. Sudirman No.123" readonly>
</div>

<!-- Embed Google Maps -->
<div class="mb-3">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.2416548638334!2d118.16360277477808!3d1.6108130983741944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x320ce27bc5516d37%3A0x11637535911b3e5e!2sRumah%20Sakit%20Umum%20Daerah%20Talisayan!5e0!3m2!1sid!2sid!4v1733232246243!5m2!1sid!2sid"
          ...
          <div class="row gy-4">
            ...
            <div class="col-12">
              <div class="input-group p-0">
                ...
                <input class="form-control" type="text" placeholder="Nama Rumah Sakit" name="HospitalName"
                  value="RSUD Kota Medan">
              </div>
            </div>
            <!-- Alamat Rumah Sakit -->
            <div class="col-12">
              <div class="input-group p-0">
                <span class="input-group-text bg-transparent" data-bs-toggle="tooltip"
                  data-bs-title="Alamat Rumah Sakit">
                  <i class="las la-map fs-4"></i>
                </span>
                <input class="form-control" type="text" placeholder="Alamat Rumah Sakit" name="HospitalAddress"
