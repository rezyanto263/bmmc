    ...
    <div class="container-fluid p-0 d-flex flex-column justify-content-between">
        ...
        <div class="sidebar-menu">
            <ul class="p-0 m-0">
                ...
                <li>
                    <a class="d-flex align-items-center gap-3 ps-4 py-3 <?= $subtitle == 'Doctor'?'active':''; ?>" href="<?= base_url('hospital/Doctor') ?>" data-bs-toggle="tooltip" data-bs-placement="right" data-bs-title="Doctor">
