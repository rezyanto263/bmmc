<div class="content-body py-3">
    ...
    <table id="insurancesTable" class="table" style="width:100%">
        <thead>
            <tr>
                <th class="text-start">Tier Name</th>
...
<!-- Modal Add -->
<div class="modal fade" id="addInsuranceModal" data-bs-backdrop="static" data-bs-keyboard="false">
...
<div class="modal fade" id="editInsuranceModal" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
...
<div class="modal fade" id="deleteInsuranceModal" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
