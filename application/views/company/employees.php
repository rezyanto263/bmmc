                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="input-group p-0">
                                ...
                                <input class="form-control" type="text" placeholder="Employee Phone" name="employeePhone">
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="input-group p-0">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="input-group p-0">
                                ...
                                <input class="form-control" type="text" placeholder="Employee Address" name="employeeAddress">
                            </div>
                        </div>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-12 col-lg-6">
                            <div class="input-group p-0">
                                ...
                                <input class="form-control readonly" type="text" placeholder="Employee NIK" name="employeeNIK" readonly>
                            </div>
                        </div>
